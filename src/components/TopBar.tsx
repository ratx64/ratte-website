        ...
        <a
          ...
          onClick={() => {
            dismiss();
              ...
              className="shrink-0 inline-flex items-center justify-center min-h-[44px] px-3 sm:px-4 rounded-full bg-primary text-white dark:bg-accent-pink dark:text-background text-xs sm:text-sm font-semibold hover:opacity-90 active:scale-95 transition"
        >
          See codes
        </a>
        <button
